...
export function Home() {
  ...
  return (
    <>
      ...
      <section className="section">
        <SectionHead title="Academic Interests" eyebrow="Areas of Exploration" />
        <div className="row-list">
          {ARTICLES.map((a, i) => (
      ...
      <section className="section">
        <SectionHead title="Service & Leadership" eyebrow="Purpose-Driven Leadership" />
        <Reveal>
...
export function About() {
  ...
  return (
    <section className="section">
      <PageHead title="About" eyebrow="John F. Kennedy Memorial High School · Class of 2027" />
      ...
      <SubHead title="Education" eyebrow="Iselin, New Jersey" />
      <div className="stack">
        {EDUCATION.map((e, i) => (
...
export function Projects() {
  ...
  return (
    <section className="section">
      <PageHead title="Projects" eyebrow="Built & Published" />
      <div className="grid-2">
        {PROJECTS.map((p, i) => (
...
export function Publications() {
  ...
  return (
    <section className="section">
      <PageHead title="Academic Interests" eyebrow="Areas of Exploration" />
      <div className="row-list">
        {ARTICLES.map((a, i) => (
          <Reveal key={a.title} delay={i * 60}><ArticleRow a={a} /></Reveal>
        ))}
...
export function Volunteering() {
  ...
  return (
    <section className="section">
      <PageHead title="Service & Leadership" eyebrow="Purpose-Driven Leadership" />
      <Reveal>
        <div className="vol-panel">
          <div className="vol-stats">
            {VOLUNTEER.stats.map((s) => (
...
export function Sports() {
  ...
  return (
    <section className="section">
      <PageHead title="Beyond Academics" eyebrow="Personal Growth" />
